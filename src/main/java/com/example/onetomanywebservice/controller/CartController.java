...
import com.example.onetomanywebservice.model.dto.CartDto;
import com.example.onetomanywebservice.model.dto.ItemDto;
import com.example.onetomanywebservice.service.CartService;
...
public class CartController {
    ...
    public ResponseEntity<List<CartDto>> getCarts(){
        ...
        List<CartDto> itemsDto = carts.stream().map(CartDto::from).collect(Collectors.toList());
    ...
    @DeleteMapping(value="{cartId}/items/{itemId}/add")
